  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <form method='post' action="<?php echo base_url('dashboard/category'); ?>">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th width="150px" class="text-nowrap">Category</th>
                ...
                <?php
                  ...
                  foreach ($result as $data) {
                    $status = $data['category_active'];
                    $ctg = $data['category'];
                ?>
                <tr>
                  <td><b><?php echo $no;?></b></td>
                  <td class="text-nowrap"><?php echo $data['category_name'];?></td>
                  <td class="text-nowrap"><?php if($ctg == '0') { echo "Project"; } else { echo "Article"; } ?></td>
                  ...
                  <td class="text-nowrap"><a href="" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modal-edit<?php echo $data['id_category'];?>"><i class="fa fa-pencil"></i> Edit</a> <a href="" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modal-delete<?php echo $data['id_category'];?>"><i class="fa fa-trash"></i> Delete</a></td>
                </tr>
                <?php $no++; } ?>
              </table>
            </div>
      ...
      <?php
          ...
          $ctg = $data['category'];
      ?>
      <div class="modal fade" id="modal-delete<?php echo $data['id_category'];?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url('dashboard/delete_category/'.$data['id_category']); ?>">
              <div class="modal-body">
                <p>Are you sure to delete category <?php if($ctg == '1') { echo "article"; } else { echo "project"; } ?> <b><?php echo $data['category_name'];?></b></p>
              </div>
      ...
      <?php
          foreach ($result as $data) {
      ?>
      <div class="modal fade" id="modal-edit<?php echo $data['id_category'];?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="<?php echo base_url('dashboard/edit_category');?>" method="post">
              <div class="modal-body">
                <div class="row">
                  <input type="hidden" readonly value="<?php echo $data['id_category'];?>" name="id" class="form-control" >
                  <div class="form-group col-md-6">
                    <label>Name</label>
                    <input type="text" class="form-control" name="judul" placeholder="Name" value="<?php echo $data['category_name'];?>">
                  </div>
                  <div class="form-group col-md-6">
                    <label>Category</label>
                    <select class="form-control select2" name="kategori" style="width: 100%;">
