...
<head>
 ...
 <!-- Fonts START -->
  ...
  <link href="<?=base_url();?>assets/frontEnd/pages/css/portfolio.css" rel="stylesheet">
          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="<?=base_url('Sertifikasi/tempatUjiKompetensi');?>">Tempat Uji kompetensi</a></li>
                <li><a href="<?=base_url('Sertifikasi/pemegangSertifikat');?>">Pemegang Sertifikat</a></li>
