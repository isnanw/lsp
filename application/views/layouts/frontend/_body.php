						...
						<div class="item">
							<article class="featured">
								...
								<div class="details">
									...
									<h1><a href="single.html">Phasellus iaculis quam sed est elementum vel ornare ligula venenatis</a>
									</h1>
						...
						<article class="col-md-12 article-list">
							<div class="inner">
								...
								<div class="details">
									...
									<p>
										Donec consequat, arcu at ultrices sodales, quam erat aliquet diam, sit amet interdum libero nunc
										accumsan nisi.
									</p>
									<footer>
										<a href="#" class="love"><i class="ion-android-favorite-outline"></i>
							...
							<div class="inner">
								...
								<div class="details">
									...
									<p>
										...
										sollicitudin ut est. In fringilla dui.
									</p>
									<footer>
										<a href="#" class="love"><i class="ion-android-favorite-outline"></i>
											<div>4209</div>
						...
						<article class="col-md-12 article-list">
							<div class="inner">
								...
								<div class="details">
									...
									<h1><a href="single.html">Nulla facilisis odio quis gravida vestibulum Proin venenatis pellentesque
											arcu</a></h1>
									<p>
										Nulla facilisis odio quis gravida vestibulum. Proin venenatis pellentesque arcu, ut mattis nulla
										placerat et.
									</p>
									<footer>
						...
						<article class="col-md-12 article-list">
							<div class="inner">
								...
								<div class="details">
									...
									<p>
										Maecenas blandit ultricies lorem, id tempor enim pulvinar at. Curabitur sit amet tortor eu ipsum
										lacinia malesuada.
									</p>
									<footer>
										<a href="#" class="love"><i class="ion-android-favorite-outline"></i>
						...
						<div class="aside-body">
							...
							<article class="article-mini">
								<div class="inner">
									...
									<div class="padding">
										<h1><a href="single.html">dui augue facilisis lacus fringilla pulvinar massa felis quis velit</a>
										</h1>
									</div>
								</div>
							</article>
