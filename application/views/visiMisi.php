      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            <h3>Visi & Misi Lembaga Sertifikasi Profesi (LSP) SMK Negeri 2 Karanganyar</h3>
                  ...
                  <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                      <div class="item active">
                        <img src="<?=base_url();?>assets/frontEnd/pages/img/photos/smk1.jpg" alt="">
                        <div class="carousel-caption">
                          <p>Excepturi sint occaecati cupiditate non provident</p>
                        </div>
                      </div>
                      <div class="item">
                        <img src="<?=base_url();?>assets/frontEnd/pages/img/photos/smk2.jpg" alt="">
                        <div class="carousel-caption">
                          <p>Ducimus qui blanditiis praesentium voluptatum</p>
                        </div>
                      </div>
                      <div class="item">
                        <img src="<?=base_url();?>assets/frontEnd/pages/img/photos/smk3.jpg" alt="">
                        <div class="carousel-caption">
